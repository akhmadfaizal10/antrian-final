...
<head>
  ...
  <meta name="description" content="Aplikasi Antrian Berbasis IOT">
  <meta name="modificator" content="Akhmad Faizal">


  <!-- Title -->
  <title>Aplikasi Antrian Berbasis IOT</title>

  <!-- Favicon icon -->
  <link rel="shortcut icon" href="./assets/gambar/image.png" type="image/x-icon">
  ...
  <main class="flex-shrink-0">
    <div class="container pt-4">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div>
                    <button id="buka-tab" class="btn btn-sm  mt-2"><img width="auto" height="auto" src="https://img.icons8.com/wired/64/display.png" alt="display"/></button>
                </div>
      </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] + ", menuju, loket", "Indonesian Female", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
    ...
    $("#buka-tab").on("click", function() {
        if (!tabAntrian || tabAntrian.closed) {
            tabAntrian = window.open("antrian_sekarang.php", "_blank");
        } else {
            tabAntrian.focus();
        }
    });
